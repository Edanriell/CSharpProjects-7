...
public partial class BucksCoffeeShopContext : DbContext, IBucksCoffeeShopContext
{
    ...
    public BucksCoffeeShopContext(
        DbContextOptions<BucksCoffeeShopContext> options,
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        if (!Products.Any())
        {
            ...
            {
                new() { Id = new Guid("4B64CAA9-ECDE-4D59-8A15-04D8B72DF0CC") },
                new() { Id = new Guid("660EA159-55D6-4D6F-9ED3-451A45EF1664") },
                new() { Id = new Guid("93E8B6BA-7779-43D6-A866-9463B86E6D83") },
                new() { Id = new Guid("D8680971-D553-4507-94A4-AA8C6EDC198B") },
                new() { Id = new Guid("A625C343-6726-4AB2-AD6E-B71ECA7AB8BB") },
                new() { Id = new Guid("12BD2BEA-AEC6-4D31-BF9E-DACA8E032498") },
                new() { Id = new Guid("2F9E90E5-6431-46CE-9DC4-DBA828550846") }
            };
